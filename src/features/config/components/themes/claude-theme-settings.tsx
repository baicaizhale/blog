...
export function ClaudeThemeSettings() {
  const {
    register,
    formState: { errors },
  ...
  return (
    <>
      <Field
        ...
        error={errors.site?.theme?.claude?.navBarName?.message}
      >
        <Input
          {...register("site.theme.claude.navBarName")}
          className={getInputClassName(
            errors.site?.theme?.claude?.navBarName?.message,
          )}
          placeholder={m.settings_site_field_navbar_name_ph()}
        />
      </Field>
      <AssetUploadField
        name="site.theme.claude.background.homeImage"
        assetPath="themes/claude/home-image.webp"
        accept=".png,.webp,.jpg,.jpeg"
        label={m.settings_site_field_home_image()}
        hint={m.settings_site_field_home_image_hint()}
        placeholder="/images/asset/themes/claude/home-image.webp or https://picsum.photos/1600/900"
        error={errors.site?.theme?.claude?.background?.homeImage?.message}
      />
      <AssetUploadField
        name="site.theme.claude.background.globalImage"
        assetPath="themes/claude/global-image.webp"
        accept=".png,.webp,.jpg,.jpeg"
        label={m.settings_site_field_global_image()}
        hint={m.settings_site_field_global_image_hint()}
        placeholder="/images/asset/themes/claude/global-image.webp or https://picsum.photos/1600/900"
        error={errors.site?.theme?.claude?.background?.globalImage?.message}
      />
      <RangeField
        name="site.theme.claude.background.light.opacity"
        ...
        error={errors.site?.theme?.claude?.background?.light?.opacity?.message}
      />
      <RangeField
        name="site.theme.claude.background.dark.opacity"
        ...
        defaultValue={0.1}
        formatValue={(value) => value.toFixed(2)}
        error={errors.site?.theme?.claude?.background?.dark?.opacity?.message}
      />
      <RangeField
        name="site.theme.claude.background.backdropBlur"
        ...
        unit="px"
        defaultValue={8}
        error={errors.site?.theme?.claude?.background?.backdropBlur?.message}
      />
      <RangeField
        name="site.theme.claude.background.transitionDuration"
        ...
        defaultValue={600}
        error={
          errors.site?.theme?.claude?.background?.transitionDuration?.message
        }
      />
    </>
  );
