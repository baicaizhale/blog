...
interface CommentItemProps {
  comment: {
    id: number; status?: string | null; userId?: string | null; user?: { id?: string | null; image?: string | null; name?: string | null; role?: string | null } | null;
    content: JSONContent | null; createdAt: Date | string; rootId?: number | null;
  };
